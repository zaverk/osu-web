...
return [
    ...
    'too_long' => ':attribute превышено максимальное количество символов - можно использовать только до :limit characters символов.',
    ...
    'beatmapset_discussion' => [
        ...
        'invalid_beatmapset_id' => 'Указан неправильная карта.',
        'locked' => 'Обсуждение закрыто.',
        'mapper_note_wrong_user' => 'Только создатель карты может опубликовывать заметки создателя.',
        
        'hype' => [
            'guest' => 'Вам нужно войти, чтобы выполнить хайп.',
            'hyped' => 'Вы уже использовали хайп на этой карте.',
            'limit_exceeded' => 'Вы уже использовали весь свой хайп.',
            'not_hypeable' => 'Эта карта не может быть расхайплена',
            'owner' => 'Не хайпите на своих собственных картах.', // Можно улучшить данный перевод
        ],
        
        'timestamp' => [
            'exceeds_beatmapset_length' => 'Указанная временная отметка выходит за рамки ее длины.',
    ...
    'forum' => [
        ...
        'post' => [
            'beatmapset_post_no_delete' => 'Удаление метадаты у карты не допускается.',
            'beatmapset_post_no_edit' => 'Изменение метадаты у карты не допускается.',
        ],
    ...
    'user' => [
        ...
        'invalid_country' => 'Вашей страны нету в базе данных.',
        ...
        'username_no_space_userscore_mix' => 'Пожалуйста, используйте либо подчеркивания, либо пробелы, оба сразу нельзя!',
        ...
        'change_username' => [
            ...
            'username_is_same' => 'Это имя уже используется, глупый!', // Можно смягчить
        ],
    ],
];
