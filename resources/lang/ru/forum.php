...
return [
    ...
    'covers' => [
        'create' => [
            ...
            'info' => 'Разрешение изображения должно быть :dimensions. Для загрузки изображения, вы можете просто бросить его тут.',
        ],
    ...
    'topic_watches' => [
        'index' => [
            ...
            'info' => [
                ...
                'unread' => 'У вас :unread непрочитанных ответов к подписанным темам.',
            ],
        ],
    ...
    'topics' => [
        ...
        'create' => [
            ...
            'poll' => [
                ...
                'max_options_info' => 'Укажите количество вариантов, на которое сможет ответить один пользователь.',
