...
return [
    'beatmap_discussion' => [
        ...
        'nominate' => [
            'exhausted' => 'Вы достигли своего номинального лимит за день, повтори попытку завтра.',
        ],
        'resolve' => [
        ...
        'vote' => [
            ...
            'owner' => 'Нельзя голосовать в собственном обсуждений!',
    ...
    'forum' => [
        ...
        'topic' => [
            'reply' => [
                'double_post' => 'Недавно вы уже отвечали в этой теме. Подождите перед отправкой следующего поста, либо отредактируйте своё последнее сообщение.',
