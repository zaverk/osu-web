...
return [
    'index' => [
        ...
        'none_running' => 'На данный момент нету турниров, пожалуйста, попробуйте позже!',
    ...
    'show' => [
        ...
        'rank_too_low' => 'Прости, но вы не подходите по требованиям, необходимым на данный турнир!',
