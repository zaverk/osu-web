...
return [
    ...
    'support-osu' => [
        ...
        'body' => [
            ...
            'part-2' => 'Знали ли вы что поддерживая osu! вы получаете большое количество приятных плюшек, к примеру <strong>внутри игровую загрузку карт</strong>, которая срабатывает автоматически при наблюдении или в мультиплеере.',
        ],
