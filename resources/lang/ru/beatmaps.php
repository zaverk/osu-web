...
return [
    ...
    'discussions' => [
        ...
        'empty' => [
            'empty' => 'Нет отзывов!',
            'hidden' => 'Ни одно обсуждение не соответствует указанному фильтру.',
        ],

        'message_hint' => [
            'in_general' => 'Этот пост пойдет в общее обсуждение. Чтобы изменить эту карту, начните своё сообщение с временной отметкой (к примеру 00:12:345).',
    ...
    'listing' => [
        'search' => [
            'prompt' => 'начинайте вводить ключевые слова ...',
