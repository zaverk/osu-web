...
return [
    'support' => [
        ...
        'supporter_status' => [
            'contribution' => 'Большой спасибо за вашу поддержкой! Всего вы пожертвовали :dollars за :tags покупок!',
        ...
        'perks' => [
            ...
            'feel_special' => [
                ...
                'description' => 'Тёплое и особое чувство того, что вы помогли поддержать работу osu! плавной!',
            ],
